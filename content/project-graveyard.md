...
layout: "single"
description: "Things I built, used, sold, and eventually stopped working on."
---
...
The [repository](https://github.com/jgennari/ScoreKeepr) has photos, build instructions, and a video of it working. I wrote down the mistakes, too, including an incorrectly sized power regulator and a speaker footprint that didn't match the part I ordered. That's a much more useful souvenir than pretending the first board was perfect.

![The front of the ScoreKeepr circuit board, designed in 2017](/images/scorekeepr-board.png)
...
![An early Kalla screen offering AI-generated activity titles](/images/my-first-nuxt-app_1729630592665.png)
